...
export default function Foteer() {
  return (
    <footer class=" flex-col flex-1   px-3 py-8 bg-white dark:bg-blue-900  text-2 text-gray-500 dark:text-gray-200 transition-colors duration-200">
      <div class="flex flex-col ">
        ...
        <div class="mt-4 md:mt-0 flex flex-col md:flex-row ">
          ...
          <div class="mt-4 md:mt-0 flex-1 flex items-center justify-center md:border-r border-gray-100">
            ...
            <Link class="ml-4 hover:text-primary-gray-20" to="#">
          ...
          <div class="mt-7 md:mt-0 flex-1 flex flex-col items-center justify-center md:items-start md:pl-5">
            ...
            <span class="mt-7 md:mt-1">
              ...
              <a
                ...
                href="https://www.linkedin.com/in/anthony-ricse-perez-6906911b4/?originalSubdomain=pe"
              >
                Ricse
              </a>
            </span>
